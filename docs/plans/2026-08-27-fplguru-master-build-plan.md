...
> Remaining sub-plans after this override: **8** (F + all of Phase 1 + **P2h**, **P2i**, **P2e**, **P2a** done; P1g + P4c dropped). **Decided:** xG source → PitchAPI; LLM provider → Google Gemini + `$5/mo` cap. **Telegram (P2g) deferred by the user.** **P2b (Advanced xP) is now unblocked** (needs P1c ✓ + P2a ✓). Also unblocked: P2d optimizer, P2f H2H.
